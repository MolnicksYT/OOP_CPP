...
void main()
{
	...
	int index;
	int value;
	cout << "Ввести индекс добавляемого элемента: ";cin >> index;
	cout << "Ввести значение добавляемого элемента: ";cin >> value;
	list.insert(index, value);
	list.print();
	list.print_reverse();
	cout << "Ввести индекс удаляемого элемента: ";cin >> index;
	list.erase(index);
	list.print();
	list.print_reverse();
